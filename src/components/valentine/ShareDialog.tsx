    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-card rounded-3xl p-6 max-w-md w-full shadow-valentine border-2 border-primary/20 relative"
        ...
        >
          ...
          <h3 className="font-romantic text-2xl text-primary text-center mb-2">
            Share the Love!
          </h3>
          ...
          {recipientName.trim() && (
            <motion.div
              ...
              className="bg-secondary/50 rounded-xl p-3 mb-4"
            >
          ...
          {shareLink && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="bg-muted rounded-xl p-3 mb-4 flex items-center gap-2"
            >
              <input
                type="text"
                value={shareLink}
          ...
          <div className="flex flex-col gap-3">
            <motion.button
              ...
              className="w-full bg-[#25D366] text-white font-bold py-3 rounded-full flex items-center justify-center gap-2"
            ...
            <motion.button
              onClick={shareNative}
              className="w-full bg-valentine-gradient text-primary-foreground font-bold py-3 rounded-full flex items-center justify-center gap-2"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
